 ...
 *
 * SQL Power Library is free software; you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the Free
 * Software Foundation; either version 3 of the License, or (at your option) any
 * later version.
 *
 * SQL Power Library is distributed in the hope that it will be useful, but
 ...
 */
/**
 * The SQLType class is a holder for a (name, typecode) pair. The type codes
 * come from java.sql.Types, which themselves come from the XOPEN specification.
 */
public class SQLType {
    ...
    /**
     * Returns a shared, static array of all defined types. Please don't modify
     * the returned array!
     *
     * @return a array of SQLType objects
     */
    ...
    /**
     * Returns a reference to the shared instance of SQLType that *has the
     * requested type code. If <code>typecode</code> is not a valid type code,
     * returns null.
     * @param typecode the typecode
     * @return a SQLType object or null
     */
     ...
     * {@link Types}.
     * @return A BasicSQLType object that corresponds to the given type value
     */
    ...
    /**
     * Takes an int that should represent a valye from {@link Types}, and
     * converts it to a java class.
     *
     * @param type An int that corresponds with one of the constant values in
     * {@link Types}.
     * @return A {@link Class}
